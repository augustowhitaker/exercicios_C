...
float somaDeDigitos(float num1, float num2){//fazendo a soma e invocando a outra funcao "valorabsoluto" quando necessario
    ...
    if(num2 < 0){
        num2 = valorAbsoluto(num2);//perceba que é colocado dentro do parametro da funcao do valorAbsoluto o proprio num2/num1, pois agora os nums passarão a valer o num de dentro do parametro
    }

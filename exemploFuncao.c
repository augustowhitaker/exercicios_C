...
int main(){
    float calcularAreaRetangulo(float x, float y);//chamando a funcao no main,porem se a funcao for criada acima da funcao main e não abaixo não seria necessario invocar  ela aqui, bastaria fazer apenas o codigo abaixo.
